...
<div class='container'>
    ...
    <form action='' method='post'>
        <div class='form-group'>
            <label>Product Rating <input type='text' name='product_rating' value='<?= $data->product_rating ?>' disabled
                                         class='form-control'/></label>
            <label>Review Timestamp <input type='text' name='review_timestamp' value='<?= $data->review_timestamp ?>'
                                           disabled class='form-control'/></label>
        </div>
        <div class='form-group'>
            <label>Review Comment <input type='text' name='review_comment' value='<?= $data->review_comment ?>' disabled
